...
const caminhoPastaDocs = caminhoPastaAtual.substring(0, caminhoPastaAtual.length-20)
const destination = program.destination || `${caminhoPastaDocs}/Docs`;
...
clear()
console.log(figlet.textSync('Documentation Catalog'))
